 ...
 */
@FunctionalInterface
public interface IntUnaryOperator2 extends IntUnaryOperator {

    static <T> IntUnaryOperator2 of(IntUnaryOperator wrapped) {
        Objects.requireNonNull(wrapped);
        return wrapped instanceof IntUnaryOperator2 ? (IntUnaryOperator2) wrapped : i -> wrapped.applyAsInt(i);
    }
